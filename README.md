...
A complete development environment setup for WSL + terminal workflow with automated project management and single-password authentication. This is a pretty specific configuration for my setup, wouldn't recommend cloning it tbh.
